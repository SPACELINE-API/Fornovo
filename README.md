...
|----|---------|----------|------|
| 1 | Como engenheiro, quero criar um novo projeto, para registrar as informações da obra no sistema  | Alta | 1 |
| 2 | Como projetista, quero preencher um formulário de levantamento de campo, para fornecer os dados necessários para geração do memorial de cálculo  | Altíssima | 1 |
| 3 | Como projetista, quero importar arquivos CAD no formato DXF, para utilizar os dados da planta no memorial de cálculo | Altíssima | 1 |
...
| 03 | 11/05/2026 - 31/06/2026 | Concluído | 
...
<summary>Sprint 3</summary>
  ...
  <ul>
    ...
    <li> Sininho de notificações para atualizar o usuário do que foi alterado</li>
  </ul>
